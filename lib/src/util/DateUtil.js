...
export function equals(input1, input2) { return input1 == input2; }
export function equalsIgnoreCase(input1, input2) { return input1.toLocaleLowerCase() == input2.toLocaleLowerCase(); }
export function containsWhitespace(input) { return this.contains(input, ' '); }
